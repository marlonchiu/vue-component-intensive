...
const chapterSeventeen = () => import(/* webpackChunkName: "chapter-seventeen" */ '../views/chapter-seventeen.vue')
...
const routes = [
  ...
  {
    path: '/chapter-seventeen',
    name: 'chapterSeventeen',
    component: chapterSeventeen
  }
]
